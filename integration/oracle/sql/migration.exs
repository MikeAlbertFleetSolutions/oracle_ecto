defmodule Ecto.Integration.MigrationTest do
  ...
  defmodule CreateMigration do
    ...
    @index index(:ctable_migration, [:value], unique: true)
  ...
  defmodule AlterForeignKeyOnDeleteMigration do
    ...
    def up do
      create table(:alt_fk_usrs)

      create table(:alt_fk_psts) do
        add :afku_id, :id
      end

      alter table(:alt_fk_psts) do
    ...
    def down do
      drop table(:alt_fk_psts)
      drop table(:alt_fk_usrs)
    end
  end
  ...
  defmodule OnDeleteMigration do
    ...
    def up do
      create table(:parent1, primary_key: false) do
        add :id, :integer, primary_key: true
      end
      create table(:parent2, primary_key: false) do
        add :id, :integer, primary_key: true
      end
  ...
  # # timing issues with this and other tests
