defmodule OracleEcto.Connection do
  ...
  def child_spec(opts) do
    DBConnection.child_spec(Oracleex.Protocol, opts)
  end
  ...
  def insert(prefix, table, header, rows, on_conflict, returning, _placeholders),
  ...
  def execute_ddl(command) do
    OracleEcto.Migration.execute_ddl(command)
  end
end
