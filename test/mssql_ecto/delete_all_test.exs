defmodule OracleEcto.DeleteAllTest do
  ...
  defmodule Schema do
    ...
    schema "schema" do
      ...
      has_many :comments, OracleEcto.DeleteAllTest.Schema2,
        references: :x,
        foreign_key: :z
      has_one :permalink, OracleEcto.DeleteAllTest.Schema3,
        references: :y,
        foreign_key: :id
    end
  end
  ...
  defmodule Schema2 do
    ...
    schema "schema2" do
      belongs_to :post, OracleEcto.DeleteAllTest.Schema,
        references: :x,
        foreign_key: :z
    end
  end
