defmodule OracleEcto.AlterTableTest do
  ...
  test "alter table" do
    ...
    ALTER TABLE "posts"
    ADD
    "title" nvarchar2(100) CONSTRAINT "posts_title_default" DEFAULT 'Untitled' NOT NULL,
  ...
  test "alter table with primary key" do
    ...
    assert execute_ddl(alter) == ["""
    ALTER TABLE "posts"
    ADD "my_pk" number generated always as identity;
    ALTER TABLE "posts"
