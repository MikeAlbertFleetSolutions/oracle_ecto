defmodule OracleEcto.SelectTest do
  ...
  defmodule Schema do
    ...
    schema "schema" do
      ...
      has_many :comments, OracleEctoTest.Schema2,
        references: :x,
        foreign_key: :z
      has_one :permalink, OracleEctoTest.Schema3,
        references: :y,
        foreign_key: :id
    end
  end
  ...
  defmodule Schema2 do
    ...
    schema "schema2" do
      belongs_to :post, OracleEctoTest.Schema,
        references: :x,
        foreign_key: :z
    end
  end
  ...
  test "from without schema" do
    ...
    assert_raise Ecto.QueryError, ~r"Oracle requires a schema module", fn ->
  ...
  defp normalize(query, operation \\ :all, counter \\ 0) do
    {query, _params, _key} = Ecto.Query.Planner.prepare(query, operation, OracleEcto, counter)
    Ecto.Query.Planner.normalize(query, operation, OracleEcto, counter)
  end
end
